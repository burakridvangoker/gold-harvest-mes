#!/usr/bin/env python3
"""hikaye.tpl.html → hikaye.html (tek dosya, kendi kendine yeten)
...
ğ/ı/ş/İ latin-ext'te. Biri eksikse harfler sessizce yedek fonta düşer.
    ...
    python3 sunum/hikaye/uret.py [cikti.html]
"""
import base64
import pathlib
import sys
...
GORSELLER = ["operator-ust", "saat-girisi-panel", "mudur", "durus-sebepleri"]
...
def main() -> None:
    sablon = (BURASI / "hikaye.tpl.html").read_text(encoding="utf-8")
    ...
    hedef = pathlib.Path(sys.argv[1]) if len(sys.argv) > 1 else BURASI / "hikaye.html"
